...
def get_config():
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='RRM', help="specify the name of environment")
    ...
    parser.add_argument("--eval_episodes", type=int, default=4, help="number of episodes of a single evaluation.")
